...
import com.oslo7.tdjpro.BuildConfig;
...
public class BillingManager implements PurchasesUpdatedListener {
    ...
    public BillingManager(Activity activity, final BillingUpdatesListener updatesListener) {
        ...
        bb = stor.decode(BB, BuildConfig.decoder);
        mActivity = activity;
    ...
    public void initiatePurchaseFlow(final String skuId, final String oldSku,
        ...
        Runnable purchaseFlowRequest = new Runnable() {
            ...
            public void run() {
                ...
                int retCode = mBillingClient.launchBillingFlow(mActivity, purchaseParams);
                Log.d(TAG, "Ret code launchBillingFlow " + retCode);
                if(retCode==7)
                    endFlow(BillingResponse.ERROR);
            }
        };
    ...
    public void endFlow(int retCode) {
        mBillingUpdatesListener.onConsumeFinished(null, retCode);
    }
    ...
    private boolean verifyValidSignature(String signedData, String signature) {
        try {
            return Security.verifyPurchase(bb, signedData, signature);
        } catch (IOException e) {
